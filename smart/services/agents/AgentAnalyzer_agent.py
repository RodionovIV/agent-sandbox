...
from settings import llm, AgentAnalyzer_prompt
from services.agents.agent_state import AgentState

_LOGGER = logging.getLogger(__name__)


class AgentanalyzerAgent:
    def __init__(self):
        pass
    ...
    async def create(self):
        ...
        self.agent = create_react_agent(llm, tools, checkpointer=MemorySaver(), prompt=AgentAnalyzer_prompt)
        self.config = {
                "configurable": {
                "thread_id": str(uuid4())
            },
