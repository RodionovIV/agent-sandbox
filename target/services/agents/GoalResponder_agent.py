...
from settings import llm, GoalResponder_prompt
from services.agents.agent_state import AgentState

_LOGGER = logging.getLogger(__name__)


class GoalresponderAgent:
    def __init__(self):
        pass
    ...
    async def create(self):
        ...
        self.agent = create_react_agent(llm, tools, checkpointer=MemorySaver(), prompt=GoalResponder_prompt)
        self.config = {
                "configurable": {
                "thread_id": str(uuid4())
            },
